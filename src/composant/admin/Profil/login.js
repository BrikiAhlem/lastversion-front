            ...
            <div className="card bg-dark text-white h-100" style={{ borderRadius: '1rem' }}>
              <div className="card-body p-5 text-center">
                <div className="mb-md-5 mt-md-4 pb-5">
                  <h2 className="fw-bold mb-2 text-uppercase" style={{ color: "white" }}>Se connecter
                  </h2>
                  ...
                  <div className="form-outline form-white mb-4">
                    <label htmlFor="typePasswordX" className="text-white me-3 mt-2">Mot de passe</label>
                    <MDBInput
                  ...
                  <button className="btn btn-outline-light btn-lg px-5" onClick={handleLogin}>Se connecter
                  </button>
