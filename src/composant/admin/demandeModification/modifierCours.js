...
const CoursListAdminModifier = () => {
  ...
  const handleSearchChange = async (event) => {
    ...
    try {
      const response = await axios.get(`http://localhost:3000/coursgratuis/searchcourssByTitreAdminmodifier?titre=${searchTerm}`);
...
export default CoursListAdminModifier;
