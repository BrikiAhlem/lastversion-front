...
const ListPublicationAdmin = () => {
  ...
  return (
    <div className="publications-list-admin" style={{ backgroundColor: '#eee', marginTop: '20px', height:"1050px" }}>
      <ToastContainer />

      <h1 className="text-center" style={{ color: '#5e4803', fontFamily: 'Roboto, sans-serif', fontSize: '40px', marginTop: '0px' }}> les demandes de création des Publications</h1>
