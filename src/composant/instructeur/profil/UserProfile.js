...
import MonetizationOnIcon from '@mui/icons-material/MonetizationOn'; // Icon for the button
...
const UserProfile = () => {
  ...
  const handleConsultRevenue = () => {
    history.push('/TableauRevenu');
  };
          ...
          <div className="profile-table" style={{ marginTop: '20px' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', marginTop: '10px' }}>
              <Button
                variant="contained"
                color="primary"
                onClick={handleConsultRevenue}
                startIcon={<MonetizationOnIcon />}
                style={{ backgroundColor: '#4caf50', color: 'white', animation: 'bounce 1s infinite' }}
              >
                Consulter Revenu
              </Button>
            </div>
