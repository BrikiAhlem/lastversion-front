                ...
                <div className="d-flex justify-content-center mb-2">
                  ...
                  <div className="flex-shrink-0 position-relative">
                    ...
                    {participantData && participantData.Avatar ? (
                      <>
                        <Avatar src={`http://localhost:3000/uploads/${participantData.Avatar}`} alt="Avatar" style={{ width: '130px', height: '140px', borderRadius: '20%' }} />
            ...
            <MDBCard className="mb-4 mb-lg-0" style={{ border: "2px solid black" }}>
              <MDBCardBody className="p-0">
                <MDBListGroup flush className="rounded-3">
                  {participantFormations.length > 0 && (
          ...
          <MDBCol lg="8">
            <MDBCard className="mb-4" style={{ border: "2px solid #000", borderTopColor: "black", borderRightColor: "black", borderBottomColor: "black", borderLeftColor: "black" }}>
              <MDBCardBody>
                ...
                <section style={{ justifyContent: "center", display: "flex", alignItems: "center", marginBottom: "10px", marginTop: "20px" }}>
                  <MDBBtn onClick={handleOpenProfileModal} style={{ backgroundColor: '#007bff', color: '#fff', border: 'none' }}>Modifier vos données</MDBBtn>
                </section>
              </MDBCardBody>
            </MDBCard>
          </MDBCol>
          <MDBCol lg="8" style={{ marginLeft: '440px', marginTop: "-20px", padding: "-30px" }}>
